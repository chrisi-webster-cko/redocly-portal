...
namespace OpenApiGenerator
{
  class Program
  {
    ...
    static string _yamlOutputFile = Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "abc" ?  "openapi/abc-spec.yaml" : "openapi/nas-spec.yaml";
    static string _jsonOutputFile = Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT") == "abc" ? "openapi/abc-spec.json" : "openapi/nas-spec.json";
